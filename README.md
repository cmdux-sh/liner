...
**Platform support (1.0.2):** macOS (arm64 + x64), Linux (arm64 + x64), and Windows (x64). The npm package installs the matching bundled CLI and TUI binaries for your platform.
...
Active solo project. The current source targets **v1.0.2** for the Go TUI npm
